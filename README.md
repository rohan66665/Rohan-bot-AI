# 🤖 RAG Bot AI
A Retrieval-Augmented Generation (RAG) application that uses document retrieval and Large Language Models (LLMs) to generate context-aware responses.
The project combines a Python/FastAPI backend with vector search, a React.js frontend, and containerized deployment.
---
## 🚀 Overview
